...
export default function Header4({ scroll, isMobileMenu, handleMobileMenu }) {
  return (
    <>
            ...
            <div className="main-header-four__top-inner">
              <div className="main-header-four__top-left">
                <div className="main-header-four__logo">
                  <Link href="index">
                    <img src="assets/images/resources/APPLY NOW" alt="" />
                  </Link>
                </div>
              ...
              <ul className="list-unstyled main-header-four__contact-list">
                <li>
                  <div className="text">
                    <span>email</span>
                    <p>
                      <Link href="mailto:customerservice@elitefunders.com">
                ...
                <li>
                  <div className="text">
                    <span>PHONE</span>
                    <p>
                      <Link href="tel:18000000000">1800 000 0000 </Link>
                    </p>
                  </div>
                </li>
              </ul>
      ...
      <div
        className={`stricky-header stricked-menu main-menu main-menu-four ${
