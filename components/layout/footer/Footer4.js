                ...
                <div
                  ...
                  <div className="footer-widget__column footer-widget__about">
                    <div className="footer-widget__logo">
                      <Link href="index">
                        <img
                          src="assets/images/resources/footer-logo-4.png"
                          alt=""
                        />
                      </Link>
                    </div>
                    <p className="footer-widget__about-text">
                      Address 301 Princes Street, Ei className
                    ...
                    <ul className="footer-widget__gallery-list list-unstyled clearfix">
                      <li>
                        <div className="footer-widget__gallery-img">
                          <img
                            src="assets/images/gallery/footer-widget-gallery-img-1.jpg"
                            alt=""
                          />
                          <Link href="#">
                      ...
                      <li>
                        <div className="footer-widget__gallery-img">
                          <img
                            src="assets/images/gallery/footer-widget-gallery-img-2.jpg"
                            alt=""
                          />
                          <Link href="#">
                            <span className="icon-plus"></span>
                      ...
                      <li>
                        <div className="footer-widget__gallery-img">
                          <img
                            src="assets/images/gallery/footer-widget-gallery-img-3.jpg"
                            alt=""
                          />
                          <Link href="#">
                            <span className="icon-plus"></span>
                      ...
                      <li>
                        <div className="footer-widget__gallery-img">
                          <img
                            src="assets/images/gallery/footer-widget-gallery-img-4.jpg"
                            alt=""
                          />
                          <Link href="#">
                            <span className="icon-plus"></span>
                      ...
                      <li>
                        <div className="footer-widget__gallery-img">
                          <img
                            src="assets/images/gallery/footer-widget-gallery-img-5.jpg"
                            alt=""
                          />
                          <Link href="#">
                            <span className="icon-plus"></span>
                      ...
                      <li>
                        <div className="footer-widget__gallery-img">
                          <img
                            src="assets/images/gallery/footer-widget-gallery-img-6.jpg"
                            alt=""
                          />
                          <Link href="#">
                            <span className="icon-plus"></span>
          ...
          <div className="container">
            <div className="site-footer__bottom-inner">
              <p className="site-footer__bottom-text">
                Copyright © 2024 Sonchoy by <Link href="#">thememx.</Link> All
                Rights Reserved
              </p>
            </div>
          </div>
