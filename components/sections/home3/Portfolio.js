        ...
        <div className="portfolio-two__bottom">
          <div className="container">
            <div className="portfolio-two__carousel-container">
              <Swiper
                {...swiperOptions}
                className="portfolio-two__carousel owl-carousel thm-owl__carousel project-style1-carousel owl-dot-style1">
                      ...
                      <li>
                        <div className="portfolio-two__box-content">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url(assets/images/project/portfolio-2-1.jpg)",
                            }}></div>
                          <div className="img-holder-img-bg"></div>
                          <div className="portfolio-two__box-content-inner-icon">
                            <Link
                              href="assets/images/project/portfolio-2-1.jpg"
                              className="img-popup">
                      ...
                      <li>
                        <div className="portfolio-two__box-content">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url(assets/images/project/portfolio-2-2.jpg)",
                            }}></div>
                          <div className="img-holder-img-bg"></div>
                          <div className="portfolio-two__box-content-inner-icon">
                            <Link
                              href="assets/images/project/portfolio-2-2.jpg"
                              className="img-popup">
                              <i className="icon-next"></i>
                            </Link>
                          </div>
                      ...
                      <li>
                        <div className="portfolio-two__box-content">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url(assets/images/project/portfolio-2-3.jpg)",
                            }}></div>
                          <div className="img-holder-img-bg"></div>
                          <div className="portfolio-two__box-content-inner-icon">
                            <Link
                              href="assets/images/project/portfolio-2-3.jpg"
                              className="img-popup">
                              <i className="icon-next"></i>
                            </Link>
                          </div>
