    ...
    <>
      ...
      <section className="portfolio-three">
        <div className="portfolio-three__bg-box">
          <div
            className="portfolio-three__bg"
            style={{
              backgroundImage:
                "url(assets/images/backgrounds/portfolio-three-bg.jpg)",
            }}></div>
        </div>
              ...
              <div className="portfolio-three__single">
                <div className="portfolio-three__img-box">
                  ...
                  <div className="portfolio-three__content">
                    <p className="portfolio-three__sub-title">Funding</p>
                    <h3 className="portfolio-three__title">
                      <Link href="portfolio-details">Annual Funding</Link>
                    </h3>
                  </div>
                  <div className="portfolio-three__arrow">
                    <Link
            ...
            <div
              ...
              <div className="portfolio-three__single">
                <div className="portfolio-three__img-box">
                  ...
                  <div className="portfolio-three__arrow">
                    <Link
                      href="assets/images/project/portfolio-3-4.jpg"
                      className="img-popup">
                      <span className="icon-next"></span>
                    </Link>
                  </div>
