          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="about-five__right">
                <h3 className="about-five__tilte">
                  We’re Here to
                  <br /> Assist With Protection.
                </h3>
                ...
                <div className="about-five__btn-and-author">
                  <div className="about-five__btn-box">
                    <Link href="about" className="about-five__btn thm-btn">
                      Apply Now
                    </Link>
                  </div>
                  <div className="about-five__author-img">
                    <img
                      src="assets/images/resources/about-five-author-img.jpg"
                      alt=""
                    />
                    <div className="about-five__author-sign">
                      <img
                        src="assets/images/resources/about-five-author-sign.png"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="about-five__bottom-text">
                  <p>
                    Do you have any project on mind? Call Us:
