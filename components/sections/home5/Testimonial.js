    ...
    <>
      ...
      <section className="testimonial-three">
        <div className="testimonial-three__shape-5">
          <img
            src="assets/images/shapes/testimonial-three-shape-5.png"
            alt=""
          />
        </div>
        <div className="testimonial-three__shape-6">
          <img
            src="assets/images/shapes/testimonial-three-shape-6.png"
            alt=""
          />
        </div>
                ...
                <div className="item">
                  <div className="testimonial-three__single">
                    ...
                    <p className="testimonial-three__text">
                      ...
                      domination. At the end of the day going forward normal
                      that has evolved from operational X is on the
                    </p>
                    <div className="testimonial-three__client-info">
                      <h3 className="testimonial-three__client-name">
                        <Link href="testimonial">Janes Cooper</Link>
                      </h3>
              ...
              <SwiperSlide>
                <div className="item">
                  <div className="testimonial-three__single">
                    ...
                    <div className="testimonial-three__client-info">
                      <h3 className="testimonial-three__client-name">
                        <Link href="testimonial">David Cooper</Link>
                      </h3>
                      <p className="testimonial-three__client-sub-title">
                        Designer
                      </p>
              ...
              <SwiperSlide>
                <div className="item">
                  <div className="testimonial-three__single">
                    ...
                    <div className="testimonial-three__client-img">
                      <img
                        src="assets/images/testimonial/testimonial-3-4.jpg"
                        alt=""
                      />
                    </div>
                    <p className="testimonial-three__text">
                    ...
                    <div className="testimonial-three__client-info">
                      <h3 className="testimonial-three__client-name">
                        <Link href="testimonial">Tamanna Vat</Link>
                      </h3>
                      <p className="testimonial-three__client-sub-title">
                        Designer
                      </p>
              ...
              <SwiperSlide>
                <div className="item">
                  <div className="testimonial-three__single">
                    ...
                    <div className="testimonial-three__client-img">
                      <img
                        src="assets/images/testimonial/testimonial-3-5.jpg"
                        alt=""
                      />
                    </div>
                    <p className="testimonial-three__text">
              ...
              <SwiperSlide>
                <div className="item">
                  <div className="testimonial-three__single">
                    ...
                    <div className="testimonial-three__client-img">
                      <img
                        src="assets/images/testimonial/testimonial-3-6.jpg"
                        alt=""
                      />
                    </div>
                    <p className="testimonial-three__text">
                    ...
                    <div className="testimonial-three__client-info">
                      <h3 className="testimonial-three__client-name">
                        <Link href="testimonial">Leslie Iban</Link>
                      </h3>
                      <p className="testimonial-three__client-sub-title">
                        Designer
                      </p>
