        ...
        <div className="container">
          <div className="team-three__top">
            ...
            <div className="team-three__btn-box">
              <Link href="#" className="team-three__btn thm-btn">
                JOIN OUR TEAM
              </Link>
            </div>
          </div>
          <div className="team-three__bottom">
            <Swiper
              {...swiperOptions}
              className="team-three__carousel owl-carousel owl-theme thm-owl__carousel">
                ...
                <div className="team-three__single">
                  ...
                  <div className="team-three__content">
                    <h3 className="team-three__title">
                      <Link href="team-details">Annete Black</Link>
                    </h3>
                    <p>Engineer</p>
                  </div>
                </div>
              ...
              <SwiperSlide className="item">
                <div className="team-three__single">
                  ...
                  <div className="team-three__content">
                    <h3 className="team-three__title">
                      <Link href="team-details">Anannya Wifey</Link>
                    </h3>
                    <p>Developer</p>
                  </div>
                </div>
              ...
              <SwiperSlide className="item">
                <div className="team-three__single">
                  ...
                  <div className="team-three__content">
                    <h3 className="team-three__title">
                      <Link href="team-details">Shamim Khan</Link>
                    </h3>
                    <p>Co Founder</p>
                  </div>
                </div>
              ...
              <SwiperSlide className="item">
                <div className="team-three__single">
                  ...
                  <div className="team-three__content">
                    <h3 className="team-three__title">
                      <Link href="team-details">Ananta Khan</Link>
                    </h3>
                    <p>Designer</p>
                  </div>
                </div>
