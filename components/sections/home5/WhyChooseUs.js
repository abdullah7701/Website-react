                ...
                <div className="row">
                  <div className="col-xl-6 col-lg-6">
                    <div className="why-choose-four__img-1">
                      <img
                        src="assets/images/resources/why-choose-four-img-1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  <div className="col-xl-6 col-lg-6">
                    <div className="why-choose-four__img-2">
                      <img
                        src="assets/images/resources/why-choose-four-img-2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="why-choose-four__right">
                ...
                <p className="why-choose-four__text">
                  ...
                  dignissim maximus ipsum, sed rutrum metus tincidunt et. Sed
                  eget tincidunt ipsum. Eget tincidunt
                </p>
                <ul className="why-choose-four__points list-unstyled">
                  <li>
                    ...
                    <h3 className="why-choose-four__title">
                      <Link href="about">
                        Save Your
                        <br /> Money
                      </Link>
                    </h3>
                    <Link href="about" className="why-choose-four__arrow">
