                ...
                <SwiperSlide className="swiper-slide">
                  <div className="main-slider-five__main-content-inner-box">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/images/backgrounds/slider-5-1.jpg)",
                      }}></div>
                    <div className="main-slider-five__shape-1">
                      <img
                        src="assets/images/shapes/main-slider-five-shape-1.png"
                        alt=""
                      />
                    </div>
                    <div className="main-slider-five__shape-2">
                      <img
                        src="assets/images/shapes/main-slider-five-shape-2.png"
                        alt=""
                      />
                    </div>
                    <div className="container">
                      <div className="main-slider-five__main-content-inner">
                        ...
                        <div className="main-slider-five__btn-and-text-box">
                          ...
                          <p className="main-slider-five__text-box">
                            {" "}
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="main-slider-five__main-content-inner-box">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/images/backgrounds/slider-5-2.jpg)",
                      }}></div>
                    <div className="main-slider-five__shape-1">
                      <img
                        src="assets/images/shapes/main-slider-five-shape-1.png"
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="main-slider-five__main-content-inner-box">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/images/backgrounds/slider-5-3.jpg)",
                      }}></div>
                    <div className="main-slider-five__shape-1">
                      <img
                        src="assets/images/shapes/main-slider-five-shape-1.png"
              ...
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="main-slider-five__img-holder">
                    <img
                      src="assets/images/resources/main-slider-five-thumb-1-1.jpg"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="swiper-slide">
                  <div className="main-slider-five__img-holder">
                    <img
                      src="assets/images/resources/main-slider-five-thumb-1-2.jpg"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="swiper-slide">
                  <div className="main-slider-five__img-holder">
                    <img
                      src="assets/images/resources/main-slider-five-thumb-1-3.jpg"
                      alt=""
                    />
                  </div>
                </div>
