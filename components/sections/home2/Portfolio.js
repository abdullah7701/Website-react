    ...
    <>
      ...
      <section className="portfolio-one">
        <div className="portfolio-one__wrapper">
          <Swiper
            {...swiperOptions}
            className="portfolio-one__carousel owl-carousel owl-theme thm-owl__carousel">
              ...
              <div className="portfolio-one__single">
                <div className="portfolio-one__img-box">
                  ...
                  <div className="portfolio-one__content">
                    <div
                      className="portfolio-one__content-shape"
                      style={{
                        backgroundImage:
                          "url(assets/images/shapes/portfolio-one-content-shape.png)",
                      }}></div>
                ...
                <div className="portfolio-one__img-box">
                  ...
                  <div className="portfolio-one__content">
                    ...
                    <div className="portfolio-one__title-box">
                      <p className="portfolio-one__sub-title">San Fransisco</p>
                      <h3 className="portfolio-one__title">
                        <Link href="portfolio-details">Funding Analytics</Link>
                      </h3>
                    </div>
                    <div className="portfolio-one__arrow">
                      <Link
