            ...
            <div className="section-title text-center">
              <div className="section-title__tagline-box">
                <p className="section-title__tagline">
                  Sonchoy POPULAR SERVICE
                </p>
              </div>
              <h2 className="section-title__title">
                Amazing Products
                <br /> that Protect and Reward
              </h2>
            </div>
              ...
              <ul className="services-two__services-list list-unstyled">
                  ...
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      <div className="services-two__icon">
                        <span className="icon-life-Funding"></span>
                      </div>
                    ...
                    <div className="services-two__hover-single">
                      ...
                      <p className="services-two__hover-text">
                        Nullam eu nibh vitae est tempor molestie id
                      </p>
                ...
                <li className="wow fadeInUp" data-wow-delay="200ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="health-Funding">Health Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
                ...
                <li className="wow fadeInUp" data-wow-delay="300ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="car-Funding">Car Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
                ...
                <li className="wow fadeInUp" data-wow-delay="400ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      <div className="services-two__icon">
                        <span className="icon-travel-Funding"></span>
                      </div>
                      <h3 className="services-two__title">
                        <Link href="family-Funding">Travels Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
                ...
                <li className="wow fadeInUp" data-wow-delay="500ms">
                  <div className="services-two__single-inner">
                    <div className="services-two__single">
                      ...
                      <h3 className="services-two__title">
                        <Link href="home-Funding">Home Cover</Link>
                      </h3>
                      <div className="services-two__arrow">
          ...
          <div className="container">
            <div className="services-two__bottom-inner">
              <div className="services-two__bottom-img">
                <img
                  src="assets/images/services/services-two-bottom-img.jpg"
                  alt=""
                />
              </div>
              <h3 className="services-two__bottom-title">
                Compare & Get
                <br /> Your Funding in Right Way
              </h3>
              <div className="services-two__bottom-btn-box">
                <Link
                  href="contact"
                  className="services-two__bottom-btn thm-btn">
                  GET A QUOTE
                </Link>
              </div>
            </div>
