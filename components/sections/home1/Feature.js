            ...
            <div className="col-xl-4 col-lg-6 wow fadeInLeft">
              <div className="feature-one__single">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(assets/images/shapes/blue-hover-shape.png)",
                  }}></div>
                <div className="feature-one__icon">
                  <span className="icon-protection"></span>
                </div>
                <div className="feature-one__content">
                  <p className="feature-one__sub-title">Elite Funding Group</p>
                  <h3 className="feature-one__title">
                    <Link href="about">Fast & Reliable</Link>
                  </h3>
            ...
            <div className="col-xl-4 col-lg-6 wow fadeInUp">
              <div className="feature-one__single">
                ...
                <div className="feature-one__content">
                  <p className="feature-one__sub-title">Elite Funding Group</p>
                  <h3 className="feature-one__title">
                    <Link href="about">Non-Tradtional </Link>
                  </h3>
                  <Link href="about" className="feature-one__read-more">
                    READ MORE<span className="icon-next"></span>
                  </Link>
            ...
            <div className="col-xl-4 col-lg-6 wow fadeInRight">
              <div className="feature-one__single">
                ...
                <div className="feature-one__content">
                  <p className="feature-one__sub-title">Elite Funding Group</p>
                  <h3 className="feature-one__title">
                    <Link href="about">Life Changing</Link>
                  </h3>
                  <Link href="about" className="feature-one__read-more">
                    READ MORE<span className="icon-next"></span>
                  </Link>
