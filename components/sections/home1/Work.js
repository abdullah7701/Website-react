  ...
  return (
    <>
      ...
      <section className="work-step-one">
        <div
          className="work-step-one__bg-shape"
          style={{
            backgroundImage:
              "url(assets/images/shapes/work-step-one-bg-shape.png)",
          }}
        ></div>
                ...
                <Link href="/apply">
                  <div className="work-step-one__icon">
                    ...
                    <div className="work-step-one__shape-1">
                      <img
                        src="assets/images/shapes/work-step-one-shape-1.png"
                        alt=""
                      />
                    </div>
                    <div className="work-step-one__hover-shape-1">
                      <img
                        src="assets/images/shapes/work-step-one-hover-shape-1.png"
                        alt=""
                      />
                    </div>
                    <div className="work-step-one__shape-2">
                      <img
                        src="assets/images/shapes/work-step-one-shape-2.png"
                        alt=""
                      />
                    </div>
                    <div className="work-step-one__shape-3">
                      <img
                        src="assets/images/shapes/work-step-one-shape-3.png"
                        alt=""
                      />
                    </div>
                  </div>
