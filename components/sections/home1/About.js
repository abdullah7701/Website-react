              ...
              <div className="about-one__right">
                <div className="section-title text-left">
                  <div className="section-title__tagline-box">
                    <p className="section-title__tagline">Trusted by 4,200+ Business Owners</p>
                  </div>
                  <h2 className="section-title__title">
                  How Elite Funders Gets
                    <br /> You Funded - Fast!
                  </h2>
                </div>
                ...
                <ul className="about-one__points list-unstyled">
                  <li>
                    ...
                    <p>Apply Online - 2-min app, no hard pull</p>
                  </li>
                  <li>
                    <div className="icon">
                      <span className="fas fa-check-circle"></span>
                    </div>
                    <p>Get Pre-Qualified Instantly</p>
                  </li>
                  <li>
                    <div className="icon">
                      <span className="fas fa-check-circle"></span>
                    </div>
                    <p>Review Offers & Get Funded</p>
                  </li>
                </ul>
