...
export default function Home() {
  ...
  return (
    <>
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Car Funding">
              ...
              <div className="col-xl-8 col-lg-7">
                <div className="Funding-details__left">
                  ...
                  <div className="Funding-details__img-1">
                    <img
                      src="assets/images/services/Funding-details-img-2.jpg"
                      alt=""
                    />
                  </div>
                  <h3 className="Funding-details__title-2">Car Funding</h3>
